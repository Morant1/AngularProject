...
export class BitcoinService {
  ...
  public getRate() {
    this.http.get<number>(this.RATE_URL)
      .pipe(
        map(rate => {
          return rate
        })
  ...
  public getMarketPrice() {
    this.http.get<Price>(this.MARKET_URL)
      .subscribe(price => {
